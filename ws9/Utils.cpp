...
// Replaces the destination with a new copy of the source, deallocating old
// memory if necessary
...
// Copies the source string to the destination, assumes enough space is
// available
...
// Copies up to 'len' characters from the source to the destination,
...
// Returns the length of the string (number of characters before the null
// terminator)
...
// Checks if the given character is a whitespace character (space, tab, newline,
// etc.)
...
// Checks if the entire C-string is whitespace, returns true if all characters
// are whitespace
bool Utils::isspace(const char *cstring) const {
  ...
  return cstring &&
         *cstring == 0; // Returns true if all characters were whitespace
}
