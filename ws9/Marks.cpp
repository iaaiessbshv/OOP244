...
using namespace std;
namespace seneca {
Mark::~Mark() { delete[] m_title; }
const char *Mark::title() const { return m_title; }
int Mark::mark() const { return m_mark; }
...
Marks::Marks(const Marks &other) { operator=(other); }
...
size_t Marks::size() const { return m_noOfMarks; }
